...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright DAFX2014, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/Compressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Compressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Compressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Compressor-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Compressor-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Compressor-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Compressor-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Compressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Compressor.iss",inplace=1):
